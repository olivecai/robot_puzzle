...
PICK_Z_M = 0.14800756777487412     # height to touch/grip a piece with the suction cup
PLACE_Z_M = 0.14800756777487412   # usually the same as PICK_Z_M
...
VACUUM_DIGITAL_OUT = 1  # TODO: which digital output toggles the vacuum